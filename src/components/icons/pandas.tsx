/**
 * @file src/components/icons/pandas.tsx
 * @description The official logo for pandas as an SVG component.
 */
export const PandasIcon = (props: React.SVGProps<SVGSVGElement>) => (
